...
echo.
echo =======================================================================
echo  RAVENM INER HQ -- BUILD FORGE -- v3.9.0
...
:: Plain if-exist checks -- no delayed expansion needed here
:: -----------------------------------------------------------------------
set SRC=

if exist "%~dp0Ravenminer_HQ_3.9.0_RC3_fixed.py"    set "SRC=%~dp0Ravenminer_HQ_3.9.0_RC3_fixed.py"    & goto :found_src
if exist "%~dp0Ravenminer_HQ_3.9.0_fixed.py"         set "SRC=%~dp0Ravenminer_HQ_3.9.0_fixed.py"         & goto :found_src
if exist "%~dp0Ravenminer_HQ_3.9.0_RC3.py"           set "SRC=%~dp0Ravenminer_HQ_3.9.0_RC3.py"           & goto :found_src
if exist "%~dp0Ravenminer_HQ_3.9.0_RC2.py"           set "SRC=%~dp0Ravenminer_HQ_3.9.0_RC2.py"           & goto :found_src

if exist "%~dp0src\Ravenminer_HQ_3.9.0_RC3_fixed.py" set "SRC=%~dp0src\Ravenminer_HQ_3.9.0_RC3_fixed.py" & goto :found_src
if exist "%~dp0src\Ravenminer_HQ_3.9.0_fixed.py"     set "SRC=%~dp0src\Ravenminer_HQ_3.9.0_fixed.py"     & goto :found_src
if exist "%~dp0src\Ravenminer_HQ_3.9.0_RC3.py"       set "SRC=%~dp0src\Ravenminer_HQ_3.9.0_RC3.py"       & goto :found_src

if exist "%~dp0..\Ravenminer_HQ_3.9.0_RC3_fixed.py"  set "SRC=%~dp0..\Ravenminer_HQ_3.9.0_RC3_fixed.py"  & goto :found_src
if exist "%~dp0..\Ravenminer_HQ_3.9.0_fixed.py"      set "SRC=%~dp0..\Ravenminer_HQ_3.9.0_fixed.py"      & goto :found_src
if exist "%~dp0..\Ravenminer_HQ_3.9.0_RC3.py"        set "SRC=%~dp0..\Ravenminer_HQ_3.9.0_RC3.py"        & goto :found_src

:: --- wildcard fallback: first Ravenminer_HQ_*.py in same folder ---------
for %%F in ("%~dp0Ravenminer_HQ_*.py") do (
    set "SRC=%%F"
    goto :found_src
)

:: --- still not found -- ask user (retry loop) ----------------------------
:ask_path
echo.
echo [WARN] Could not auto-locate any Ravenminer_HQ_*.py file.
echo.
...
:cancelled
echo.
echo  Forge abandoned. No files were changed.
echo.
