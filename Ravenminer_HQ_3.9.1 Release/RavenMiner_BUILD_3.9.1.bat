...
rem  -----------------------------------------------------------------------
rem  Colour palette -- matches Ravenminer_HQ_3.9.1.py
...
echo.
echo  %PGLW%  ========================================================================%RST%
echo  %GBRT%   RAVENM INER HQ  --  BUILD FORGE  --  v3.9.1%RST%
...
if exist "%~dp0src\Ravenminer_HQ_3.9.1.py"           set "SRC=%~dp0src\Ravenminer_HQ_3.9.1.py"           & goto :found_src
if exist "%~dp0..\Ravenminer_HQ_3.9.1.py"            set "SRC=%~dp0..\Ravenminer_HQ_3.9.1.py"            & goto :found_src
